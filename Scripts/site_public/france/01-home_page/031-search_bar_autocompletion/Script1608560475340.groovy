...
dept = WebUI.getText(findTestObject('site_public/france/01-home_page/01-section_search/01-search_bar/11-input_where/li_departement'), FailureHandling.STOP_ON_FAILURE)
